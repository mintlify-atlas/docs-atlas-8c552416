---
title: 'Before-and-after examples for all four Karpathy principles'
description: 'Concrete before-and-after code examples showing what LLMs commonly do wrong and what correct behavior looks like for all four principles.'
---
